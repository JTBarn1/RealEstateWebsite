<%@ Page Language="C#" AutoEventWireup="true" MaintainScrollPositionOnPostback="true" CodeBehind="ListingCreation.aspx.cs" Inherits="Project_3.ListingCreationPage" %>
...
<body class="formBody">
    <form id="form1" runat="server">
        ...
        <div class="container-lg mt-4">
            <h1 class="mb-4">Add a new listing</h1>
            ...
            <h4>Rooms:</h4>
            <div id="divRoomTable" runat="server" visible="false" class="mb-3">
                <table class="table">
                    <thead>
                        <tr>
                            <th>Type</th>
            ...
            <div id="divImages" runat="server" class="mb-3">
                <h4>Images:</h4>
                <div id="divImageTable" runat="server" visible="false" class="mb-3">
                    <table class="table">
                        <thead>
                            <tr>
            ...
            <div class="d-flex justify-content-center">
                <asp:Button ID="btnSubmitHouse" runat="server" CssClass="btn btn-primary" Text="Create Listing" OnClick="btnSubmitHouse_Click" ValidationGroup="grpSubmit" />
            </div>
        </div>
    </form>
    <br />
